...
<body>
  <aside>
    <div id="user_meta">
      ...
      <a href="{{ SITEURL }}/pages/welcome.html">
        {% if USER_LOGO_URL %}
        <img src="{{ USER_LOGO_URL }}" alt="logo">
        {%- if ROUND_USER_LOGO %} class="round-img"{% endif %}>
        {% else %}
        <img src="{{ SITEURL }}/theme/images/Kiki_Sandwich_crop.png" alt="logo">
        {% endif %}
      </a>
      {% endif %}
      <h2><a href="{{ SITEURL }}/pages/welcome.html">{{ SITENAME }}</a></h2>
      <p>{{ TAGLINE }}</p>
      <ul>
  ...
  <main>
    ...
    <div id="ending_message">
      <p>&copy; {{ AUTHOR }}. Built using <a href="http://getpelican.com" target="_blank">Pelican</a>. Modified <a href="https://github.com/gfidente/pelican-svbhack" target="_blank">pelican-svbhack</a> theme.</p>
    </div>
  </main>
